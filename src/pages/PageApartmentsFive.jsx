        ...
        <div className="pageApartmentsContent">
            ...
            <div className="pageApartmentsContentContainer">
                <div className="container">
                    ...
                    <h1 className='pageApartmentsTitle'>2 комн. кв., 5/25 этаж</h1>
                    <div className="pageApartmentsLine"></div>
                    <img className='pageApartmentsImg' src="img/apartments5.jpg" alt="apartments img" width="800" height="500"/>
                    <div className="pageApartmentsLine"></div>
                    ...
                    <div className="pageApartmentsDescrContainer">
                        ...
                        <p className='pageApartmentsDescrText'>
                            Просторная квартира для большой семьи выполнен в стиле Датской классики.
                        ...
                        <div className="apartmentsPlanContainerFivePage">
                            <img src="img/apartments_two_bedroom_plan2.png" alt="penthouse plan"  width="600" height="500"/>
...
export default pageApartmentsFive;