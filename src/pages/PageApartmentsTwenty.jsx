        ...
        <div className="pageApartmentsContent">
            ...
            <div className="pageApartmentsContentContainer">
                <div className="container">
                    ...
                    <h1 className='pageApartmentsTitle'>2 комн. кв., 16/25 этаж</h1>
                    <div className="pageApartmentsLine"></div>
                    <img className='pageApartmentsImg' src="img/apartments20.jpg" alt="apartments img" width="800" height="500"/>
                    <div className="pageApartmentsLine"></div>
                    ...
                    <div className="pageApartmentsDescrContainer">
                        ...
                        <p className='pageApartmentsDescrText'>
                            Квартира с искусным объединением разножанровых стилей и разнородны дизайнерских решений. 
                        ...
                        <div className="apartmentsPlanContainerTenPage">
...
export default pageApartmentsTwenty;