...
function pageApartmentsEighteen() {
    return(
        <div className="pageApartmentsContent">
            ...
            <div className="pageApartmentsContentContainer">
                <div className="container">
                    ...
                    <h1 className='pageApartmentsTitle'>2 комн. кв., 18/25 этаж</h1>
                    <div className="pageApartmentsLine"></div>
                    <img className='pageApartmentsImg' src="img/apartments18.jpg" alt="apartments img" width="800" height="500"/>
                    <div className="pageApartmentsLine"></div>
                    ...
                    <div className="pageApartmentsDescrContainer">
                        ...
                        <p className='pageApartmentsDescrText'>
                            Квартира со сдержанным стилем и функциональным минимализмом. Балкон с панорамным видом. 
                        ...
                        <div className="apartmentsPlanContainerEightPage">
...
export default pageApartmentsEighteen;