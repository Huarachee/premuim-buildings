        ...
        <div className="pageApartmentsContent">
            ...
            <div className="pageApartmentsContentContainer">
                <div className="container">
                    ...
                    <h1 className='pageApartmentsTitle'>1 комн. кв., 2/25 этаж</h1>
                    <div className="pageApartmentsLine"></div>
                    <img className='pageApartmentsImg' src="img/apartments7.jpg" alt="apartments img" width="800" height="500"/>
                    <div className="pageApartmentsLine"></div>
                    ...
                    <div className="pageApartmentsDescrContainer">
                        ...
                        <p className='pageApartmentsDescrText'>
                            Уютная квартира в стиле современной классики. 
                        ...
                        <div className="apartmentsPlanContainerSevenPage">
                            <img src="img/apartments_plan1.png" alt="penthouse plan"  width="600" height="500"/>
...
export default pageApartmentsSeven;