...
function pageApartmentsFourteen() {
    return(
        <div className="pageApartmentsContent">
            ...
            <div className="pageApartmentsContentContainer">
                <div className="container">
                    ...
                    <h1 className='pageApartmentsTitle'>1 комн. кв., 11/25 этаж</h1>
                    <div className="pageApartmentsLine"></div>
                    <img className='pageApartmentsImg' src="img/apartments14.jpg" alt="apartments img" width="800" height="500"/>
                    <div className="pageApartmentsLine"></div>
                    ...
                    <div className="pageApartmentsDescrContainer">
                        ...
                        Уютная квартира в британском стиле. Балкон с панорамным видом. 
                        Можно взять в ипотеку или на материнский капитал.
                            ...
                            - Ванная комната при второй комнате;<br/>
                        </p>
                        <div className="apartmentsPlanContainerFourteenPage">
                            <img src="img/apartments_plan3.png" alt="penthouse plan"  width="600" height="500"/>
...
export default pageApartmentsFourteen;