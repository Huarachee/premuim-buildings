...
function pageApartmentsThirteen() {
    return(
        <div className="pageApartmentsContent">
            ...
            <div className="pageApartmentsContentContainer">
                <div className="container">
                    ...
                    <h1 className='pageApartmentsTitle'>2 комн. кв., 12/25 этаж</h1>
                    <div className="pageApartmentsLine"></div>
                    <img className='pageApartmentsImg' src="img/apartments13.jpg" alt="apartments img" width="800" height="500"/>
                    <div className="pageApartmentsLine"></div>
                    ...
                    <div className="pageApartmentsDescrContainer">
                        ...
                        Угловая квартира в стиле Лофт. Балкон с панорамным видом. 
                        ...
                        <div className="apartmentsPlanContainerThirteenPage">
                            ...
                            <div className="apartmentsDot apartmentsDot--6">
                                <p className="apartmentsDotText">
                                    Ванная комната при второй комнате.
                                </p>
                            </div>
...
export default pageApartmentsThirteen;