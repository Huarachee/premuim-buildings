        ...
        <div className="pageApartmentsContent">
            ...
            <div className="pageApartmentsContentContainer">
                <div className="container">
                    ...
                    <h1 className='pageApartmentsTitle'>3 комн. кв., 8/25 этаж</h1>
                    <div className="pageApartmentsLine"></div>
                    <img className='pageApartmentsImg' src="img/apartments9.jpg" alt="apartments img" width="800" height="500"/>
                    <div className="pageApartmentsLine"></div>
                    ...
                    <div className="pageApartmentsDescrContainer">
                        ...
                        <p className='pageApartmentsDescrText'>
                            Большая квартира для всей семьи в стиле Барокко.
...
export default pageApartmentsNine;