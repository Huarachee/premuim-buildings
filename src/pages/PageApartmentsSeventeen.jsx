...
function pageApartmentsSeventeen() {
    return(
        <div className="pageApartmentsContent">
            ...
            <div className="pageApartmentsContentContainer">
                <div className="container">
                    ...
                    <h1 className='pageApartmentsTitle'>1 комн. кв., 12/25 этаж</h1>
                    <div className="pageApartmentsLine"></div>
                    <img className='pageApartmentsImg' src="img/apartments17.jpg" alt="apartments img" width="800" height="500"/>
                    <div className="pageApartmentsLine"></div>
                    ...
                    <div className="pageApartmentsDescrContainer">
                        ...
                        <p className='pageApartmentsDescrText'>
                            Квартира со стилем Арт-нуво. Балкон с панорамным видом. 
                        ...
                        <div className="apartmentsPlanContainerFourPage">
...
export default pageApartmentsSeventeen;