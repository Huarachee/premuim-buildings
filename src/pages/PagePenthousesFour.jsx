        ...
        <div className="pagePenthousesContent">
            ...
            <div className="pagePenthousesContentContainer">
                <div className="container">
                    ...
                    <h1 className='pagePenthousesTitle'>Пентхаус в 4 корпусе ЖК</h1>
                    <div className="pagePenthousesLine"></div>
                    <img className='pagePenthousesImg' src="img/penthouses4.jpg" alt="" width="800" height="500"/>
                    <div className="pagePenthousesLine"></div>
                    ...
                    <div className="pagePenthousesDescrContainer">
                        ...
                        <div className="penthousesPlanContainerFourPage">
                            <img src="img/penthouse_plan4.png" alt="penthouse plan"  width="600" height="500"/>
...
export default PagePenthousesFour;