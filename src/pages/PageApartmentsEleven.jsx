        ...
        <div className="pageApartmentsContent">
            ...
            <div className="pageApartmentsContentContainer">
                <div className="container">
                    ...
                    <h1 className='pageApartmentsTitle'>1 комн. кв., 5/25 этаж</h1>
                    <div className="pageApartmentsLine"></div>
                    <img className='pageApartmentsImg' src="img/apartments11.jpg" alt="apartments img" width="800" height="500"/>
                    <div className="pageApartmentsLine"></div>
                    ...
                    <div className="pageApartmentsDescrContainer">
                        ...
                        Квартира для молодёжи в стиле Хай-тек. Балкон с панорамным видом. 
                        ...
                        <div className="apartmentsPlanContainerElevenPage">
                            <img src="img/apartments_plan2.png" alt="penthouse plan"  width="600" height="500"/>
...
export default pageApartmentsEleven;