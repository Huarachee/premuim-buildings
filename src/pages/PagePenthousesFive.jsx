        ...
        <div className="pagePenthousesContent">
            ...
            <div className="pagePenthousesContentContainer">
                <div className="container">
                    ...
                    <h1 className='pagePenthousesTitle'>Пентхаус в 5 корпусе ЖК</h1>
                    <div className="pagePenthousesLine"></div>
                    <img className='pagePenthousesImg' src="img/penthouses5.jpg" alt="" width="800" height="500"/>
                    <div className="pagePenthousesLine"></div>
                    ...
                    <div className="pagePenthousesDescrContainer">
                        ...
                        <div className="penthousesPlanContainerFivePage">
                            <img src="img/penthouse_plan5.png" alt="penthouse plan"  width="600" height="400"/>
                            ...
                            <div className="penthousesDot penthousesDot--2">
                                <p className="penthousesDotText">
                                    Основная спальня. Со светлыми стенами.
                                </p>
                            </div>
...
export default PagePenthousesFive;