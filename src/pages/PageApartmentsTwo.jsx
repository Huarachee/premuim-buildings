        ...
        <div className="pageApartmentsContent">
            ...
            <div className="pageApartmentsContentContainer">
                <div className="container">
                    ...
                    <h1 className='pageApartmentsTitle'>3 комн. кв., 3/25 этаж</h1>
                    <div className="pageApartmentsLine"></div>
                    <img className='pageApartmentsImg' src="img/apartments2.jpg" alt="" width="800" height="500"/>
                    <div className="pageApartmentsLine"></div>
                    ...
                    <div className="pageApartmentsDescrContainer">
                        ...
                        <p className='pageApartmentsDescrText'>
                            Просторная квартира для большой семьи выполнен в стиле французского кантри.
                        ...
                        <div className="apartmentsPlanContainerTwoPage">
...
export default pageApartmentsTwo;