        ...
        <div className="pagePenthousesContent">
            ...
            <div className="pagePenthousesContentContainer">
                <div className="container">
                    ...
                    <h1 className='pagePenthousesTitle'>Пентхаус в 6 корпусе ЖК</h1>
                    <div className="pagePenthousesLine"></div>
                    <img className='pagePenthousesImg' src="img/penthouses6.jpg" alt="" width="800" height="500"/>
                    <div className="pagePenthousesLine"></div>
                    ...
                    <div className="pagePenthousesDescrContainer">
                        ...
                        <div className="penthousesPlanContainerSixPage">
                            <img src="img/penthouse_plan6.png" alt="penthouse plan"  width="600" height="400"/>
...
export default PagePenthousesSix;